...
A list of submitted files:
    ...
    server.py
    index.html(test), The test file index.html which is the main page of scu.edu.com.
    README.txt
    test.png(png file transmission test)
    screenshots, results of my program's correct implementation
...
Demo/screenshots: under screenshots/